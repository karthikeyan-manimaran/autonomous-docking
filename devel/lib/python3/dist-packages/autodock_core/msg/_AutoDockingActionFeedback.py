...
"""autogenerated by genpy from autodock_core/AutoDockingActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class AutoDockingActionFeedback(genpy.Message):
  _md5sum = "3c87c1a08a9477d780a74ec3b7d51d7f"
  _type = "autodock_core/AutoDockingActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','autodock_core/AutoDockingFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = autodock_core.msg.AutoDockingFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = autodock_core.msg.AutoDockingFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.state,) = _get_struct_B().unpack(str[start:end])
      return self
