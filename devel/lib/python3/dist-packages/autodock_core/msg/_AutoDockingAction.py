...
"""autogenerated by genpy from autodock_core/AutoDockingAction.msg. Do not edit."""
import codecs
import sys
...
import autodock_core.msg
import genpy
import std_msgs.msg

class AutoDockingAction(genpy.Message):
  _md5sum = "e0e6564f930e9cca402329d1b20995e5"
  _type = "autodock_core/AutoDockingAction"
...
"""
  ...
  _slot_types = ['autodock_core/AutoDockingActionGoal','autodock_core/AutoDockingActionResult','autodock_core/AutoDockingActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = autodock_core.msg.AutoDockingActionGoal()
      if self.action_result is None:
        self.action_result = autodock_core.msg.AutoDockingActionResult()
      if self.action_feedback is None:
        self.action_feedback = autodock_core.msg.AutoDockingActionFeedback()
    else:
      self.action_goal = autodock_core.msg.AutoDockingActionGoal()
      self.action_result = autodock_core.msg.AutoDockingActionResult()
      self.action_feedback = autodock_core.msg.AutoDockingActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.docking_waypoint
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.docking_waypoint = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.docking_waypoint = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      (self.action_feedback.feedback.state,) = _get_struct_B().unpack(str[start:end])
      return self
